...
<html lang="en">
    ...
    <head>
        ...
        <title>
            <fmt:message key="registration.page"/>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <form method="POST" action="<%= request.getContextPath()%>/RegistrationServlet">
                                ...
                                <label class="control-label"><fmt:message key="confirm.email"/></label>
                                ...
                                <label class="control-label"><fmt:message key="confirm.password"/></label>
