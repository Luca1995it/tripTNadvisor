...
<html lang="en">
    <head>
        ...
        <title>
            <fmt:message key="scrivi.rec"/>
            <c:if test="${utente != null}">
                - <c:out value="${utente.getNomeCognome()}"/>
            </c:if>
        </title>
        <c:set value="/private/scriviRecensione.jsp" scope="session" var="lastPage"/>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="intro-text">
                            <span class="name"><fmt:message key="rec.for"/> <c:out value="${ristorante.getNome()}"/></span>
                            <hr class="star-light">
