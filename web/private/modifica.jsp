                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="intro-text">
                            <span class="name"><fmt:message key="page.edit.profile"/> <c:out value="${utente.getNomeCognome()}"/></span>
                            <hr class="star-light">
                            
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                <label class="control-label"><fmt:message key="let.empty.field"/></label>
                                <label class="label-danger"><c:out value="${message}"/></label>
                                <br>
                                <form enctype='multipart/form-data' method="POST" action="<%= request.getContextPath()%>/private/ModificaProfiloServlet">
                                    ...
                                    <br> 
                                    <label class="control-label"><fmt:message key="insert.new.surname"/></label>
                                    <input name="cognome" type="text" class="form-control"> 
                                    <br>
                                    <label class="control-label"><fmt:message key="insert.new.mail"/></label>
                                    <input name="mail" type="text" class="form-control"> 
                                    <br>      
                                    <label class="control-label"><fmt:message key="insert.old.password"/> </label>
                                    <input name="passOld" type="text" class="form-control">
                                    <br>
                                    <label class="control-label"><fmt:message key="insert.new.password"/></label>
                                    <input name="pass1" type="text" class="form-control">
                                    <br>
                                    <label class="control-label"><fmt:message key="repeat.new.password"/></label>
                                    <input name="pass2" type="text" class="form-control"> <br>
                                    <br>
                                    <label class="control-label"><fmt:message key="upload.new.picture"/></label>
                                    <input type='file' name='nuovoAvPath'>
                                    <br>
                                    <button type='submit' class="btn btn-primary"><fmt:message key="applica"/></button>
                                </form>
                            </div>
                            <div class="col-md-4"></div>
                        </div>
