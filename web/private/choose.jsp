...
<html lang="en">
    <head>
        ...
        <title>
            <fmt:message key="scegli.foto"/>
            <c:if test="${utente != null}">
                - <c:out value="${utente.getNomeCognome()}"/>
            </c:if>
        </title>
        <c:set value="/private/choose.jsp" scope="session" var="lastPage"/>
            ...
            <div class="container">
                <div class="row">
                    <div class="intro-text">
                        <span class="name"><fmt:message key="add.photo.restaurant"/></span>
                        <hr class="star-light">
                        ...
                        <div class="col-md-4">
                            <form enctype='multipart/form-data' method="POST" action="<%= request.getContextPath()%>/private/AddFotoServlet">
                                ...
                                <br>
                                <label class="control-label"><fmt:message key="choose.image"/></label>
                                <input type='file' name='avPath'/>
                                <br>
                                <button type='submit' class="btn btn-primary"><fmt:message key="carica"/></button>
                            </form>
                        </div>
                        <div class="col-md-4"></div>
                    </div>
