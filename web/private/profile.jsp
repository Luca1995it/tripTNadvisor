                    ...
                    <div class="col-md-12">
                        <div class="intro-text">
                            ...
                            <div class="col-md-4">
                                ...
                                <br>
                                <label class="control-label"><fmt:message key="surname"/>: <c:out value="${utente.getCognome()}"/></label>
                                <br>
                            ...
                            <div class="col-md-4">
                                ...
                                <c:if test="${utente.isRistoratore()}">
                                    ...
                                    <br>
                                    <label class="control-label"><fmt:message key="you.have"/> <c:out value="${utente.getNotifiche().size()}"/> <fmt:message key="minus.notify"/></label>
                                    <br>
                                </c:if>
                            </div>
                            <div class="col-md-4">
