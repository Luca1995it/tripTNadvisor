...
<html lang="en">
    <head>
        ...
        <title>
            <fmt:message key="not.found.title"/>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="intro-text">
                            <span class="name"><fmt:message key="not.found.title"/></span>
                            <hr class="star-light">
                            <span class="skills"><fmt:message key="not.found"/></span>
                            <br>
                            <label class="control-label"><a href="<%= request.getContextPath()%>/HomeServlet"><fmt:message key="go.home"/></a></label>
                            <br>
                            <label class="control-label"><a href="<%= request.getContextPath()%>/login.jsp"><fmt:message key="go.login"/></a></label>
                        </div>
                    </div>
                </div>
            </div>
