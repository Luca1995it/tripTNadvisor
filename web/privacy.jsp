...
<html lang="en">
    <head>
        ...
        <c:set value="/privacy.jsp" scope="session" var="lastPage"/>
        ...
        <script type="text/javascript" src="<%= request.getContextPath()%>/customScript/carica.js"></script>
        
    </head>

    <body id="page-top" class="index" onload="carica('<%= request.getContextPath()%>/privacy.html')">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="intro-text">
                            <span class="name"><fmt:message key="terms.accept"/></span>
                            <hr class="star-light">
                            <div class="container">
